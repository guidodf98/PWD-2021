...
class Usuario {
  ...
  private $usvencimientocertificado;
  private $colRoles;
  ...
  public function __construct() {
    ...
    $this->usvencimientocertificado = null;
    $this->colRoles = [];
  ...
  public function setear($datos) {
    ...
    $this->setUsVencimientoCertificado($datos['usvencimientocertificado']);
  }
  ...
  public function getUsVencimientoCertificado() {
    return $this->usvencimientocertificado;
  }
  public function setUsVencimientoCertificado($usvencimientocertificado) {
    $this->usvencimientocertificado = $usvencimientocertificado;
  }
  ...
  public function modificar() {
    ...
    $sql = "UPDATE usuario SET 
      ...
      usvencimientocertificado=" . (($this->getUsVencimientoCertificado() == '') ? "NULL" : ("'" . $this->getUsVencimientoCertificado() . "'")) . "
